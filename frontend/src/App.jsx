...
function App() {
  ...
  return (
    <div className="app">
      ...
      {!searchResults && activeTab === "Research" && (
        <ResearchTab />
      )}
      ...
      {!searchResults && activeTab === "Entities" && (
        <EntitiesTab />
      )}
      ...
      <footer className="footer">
        <div>
          GRAPHONE AI Ecosystem Intelligence
        </div>

        <div>
          Dataset-driven intelligence platform
        </div>
      </footer>
    ...
    <main className="container">
      ...
      <section className="page-heading">
        ...
        <div>
          ...
          <h1>
            AI Ecosystem Intelligence Dashboard
          </h1>

          <p>
            Explore structured intelligence collected and
            processed through the GraphOne data pipeline.
          </p>
      ...
      <section className="content-section">
        ...
        <div className="section-header">
          ...
          <div>
            ...
            <p>
              Navigate through the processed AI
        ...
        <div className="explore-grid">
          ...
          <ExploreCard
            ...
            onClick={() =>
              setActiveTab("Fresh Intelligence")
            }
          />
...
function ResearchTab() {
  ...
  const totalPages =
    Math.max(
      1,
      Math.ceil(total / PAPERS_PER_PAGE)
    );
  ...
  const loadPapers = async () => {
    ...
    try {
      ...
      let url =
        `${API}/api/papers?limit=${PAPERS_PER_PAGE}&offset=${offset}`;
    ...
    <main className="container research-page">
      ...
      <section className="page-heading">
        ...
        <div>
          ...
          <p>
            Browse indexed AI research papers collected
            through the GraphOne research pipeline.
          </p>
...
function EntitiesTab() {
  ...
  const totalPages =
    Math.max(
      1,
      Math.ceil(total / ENTITY_PAGE_SIZE)
    );
  ...
  const loadEntities = async () => {
    ...
    try {
      ...
      let url =
        `${API}/api/entities?limit=${ENTITY_PAGE_SIZE}&offset=${offset}`;
    ...
    <main className="container">
      ...
      <section className="page-heading">
        ...
        <div>
          ...
          <p>
            Explore classified entities across the
        ...
        <form onSubmit={handleSearch}>
          ...
          <div className="research-search">
            ...
            >
              ...
              <option value="OPEN_SOURCE_PROJECT">
                Open Source
              </option>
            </select>
  ...
  useEffect(() => {
    ...
    const loadFresh = async () => {
      ...
      try {
        ...
        setData({
          news: Array.isArray(result.news)
            ? result.news
            : [],
        ...
        setError(
          "Unable to load fresh intelligence."
        );
    ...
    <main className="container">
      ...
      <section className="page-heading">
        ...
        <div>
          ...
          <div className="breadcrumb">
            Home / Fresh Intelligence
          </div>

          <h1>
            Fresh AI Intelligence
          </h1>

          <p>
            Recently collected AI news and job
            intelligence from monitored sources.
          </p>
      ...
      <section className="content-section">
        ...
        <div className="section-header">
          ...
          <div>
            ...
            <p>
              Recently collected AI ecosystem news.
            </p>
      ...
      <section className="content-section">
        ...
        <div className="section-header">
          ...
          <div>
            ...
            <p>
              Recently monitored AI job sources.
            </p>

          </div>

          <div className="dataset-status">
            {data.jobs.length} sources
          </div>
    ...
    <section className="content-section">
      ...
      <div className="section-header">
        ...
        <div>
          ...
          <p>
            {data.paperCount || 0} papers and{" "}
            {data.entityCount || 0} entities matched.
          </p>
      ...
      {entities.length > 0 && (
        ...
        <>
          ...
          <div className="section-kicker search-section-gap">
            AI ENTITIES
          </div>
